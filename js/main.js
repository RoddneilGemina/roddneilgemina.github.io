    ...
    function renderModalMedia(tabType) {
        ...
        if (tabType === 'screenshot') {
            if (activeModalProject.image) {
                ...
                modalMediaContainer.innerHTML = `
                    <div class="empty-media-box">
                        <svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="color: #94a3b8;"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
            ...
            if (activeModalProject.videoUrl) {
                ...
                modalMediaContainer.innerHTML = `
                    <div class="empty-media-box">
                        <svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" style="color: #94a3b8;"><polygon points="23 7 16 12 23 17 23 7"/><rect width="15" height="14" x="1" y="5" rx="2" ry="2"/></svg>
